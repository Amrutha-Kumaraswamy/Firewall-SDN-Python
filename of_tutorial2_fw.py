...
class router (EventMixin):
  def __init__ (self, arp_for_unknowns = False):
    ...
    self.routingTable={}
    #self.routingTable[2]={}
    self.routingTable[1] = [ ['10.0.1.2', '10.0.1.2', 's1-eth1', '10.0.1.1', 1],['10.0.1.3', '10.0.1.3','s1-eth2', '10.0.1.1', 2],['10.0.2.2', '10.0.3.2', 's1-eth3', '10.0.3.1', 3]]
    self.routingTable[2] = [ ['10.0.2.2', '10.0.2.2', 's2-eth1', '10.0.2.1', 1],['10.0.1.2', '10.0.3.1', 's2-eth2', '10.0.3,2', 2],['10.0.1.3', '10.0.3.1', 's2-eth3', '10.0.3.2', 2]]
    """
    ...
    """
    self.arpTable=[['10.0.1.1','92:66:3c:5f:00:4f','1'],['10.0.2.1','26:22:39:c5:02:e9','2'],['10.0.3.1','82:2e:de:d7:db:a7','3'],['10.0.3.2','a6:5e:13:57:db:b4','4']]
  ...
  def _handle_PacketIn (self, event):
    ...
    if isinstance(packet.next, ipv4):
      ...
      s1='10.0.1.2'
      if str(dstaddr) == str(s1):
        log.debug("FIREWALL BLOCKING THE IP")
	return
      if prt != None:
